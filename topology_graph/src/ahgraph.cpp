...
std::string CAHGraph::GetNodebyId(const size_t id)
{
    ...
    for (vp = vertices(grafo); vp.first != vp.second; ++vp.first)
    {
        ...
        {
            std::ostringstream stringStream;
            stringStream << grafo[*vp.first].id << " " << grafo[*vp.first].label << " " << grafo[*vp.first].type << " " << grafo[*vp.first].x << " " << grafo[*vp.first].y << " " << grafo[*vp.first].yaw;
...
bool CAHGraph::FindPath(size_t idstart, size_t idend, std::vector<std::string>& path)
{
    ...
    {
        std::ostringstream stringStream;
        stringStream << grafo[boost::source(*pathIterator, grafo)].id << " " << grafo[boost::source(*pathIterator, grafo)].label << " " << grafo[boost::source(*pathIterator, grafo)].type << " " << grafo[boost::source(*pathIterator, grafo)].x << " " << grafo[boost::source(*pathIterator, grafo)].y << " " << grafo[boost::source(*pathIterator, grafo)].yaw;
    ...
    std::ostringstream stringStream;
    stringStream << grafo[goal].id << " " << grafo[goal].label << " " << grafo[goal].type << " " << grafo[goal].x << " " << grafo[goal].y << " " << grafo[goal].yaw;
    path.push_back(stringStream.str());
